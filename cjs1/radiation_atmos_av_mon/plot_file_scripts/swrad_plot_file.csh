...
cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/$CERES_ES4_swabs_nc
EOF
...
sdfopen $obs_in_data_dir/$CERES_EBAF_swinc_nc
sdfopen $obs_in_data_dir/$CERES_EBAF_swup_nc
EOF
...
#  defined as downward flux minus upward flux, and is positive when energy is
#  deposited toward the surface.  See "3.0 Cautions and Helpful Hints" on
#  page 11 in /net/cjs/data/ceres/CERES_EBAF-Surface_Ed4.0/v1/CERES_EBAF-Surface_Ed4.0_DQS.pdf
