...
set mod_var = 'swup_toa_clr-swup_toa+olr_clr-olr'

# start the plot file

cat << EOF > $plot_file
* open observation files
sdfopen $obs_in_data_dir/swcldfrc.toa.mon.ltm.nc
...
sdfopen $obs_in_data_dir/netcf.CER_ES4_Terra-FM1_Edition2_Rev1.climo.nc
EOF
...
cat << EOF > $plot_file
* open observation file
open $obs_in_data_dir/CER_SRBAVG1_Terra-XTRK-FM1-Edition2D.GEO-Rev1.climo.ctl
EOF
...
cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/clim_netcre.CERES_EBAF_TOA_Terra_Edition1A_200003-200510.nc
EOF
...
set mod_var = '(swdn_sfc-swup_sfc) - (swdn_sfc_clr-swup_sfc_clr) + (lwdn_sfc-lwup_sfc) - (lwdn_sfc_clr-lwup_sfc_clr)'
...
set z 1
set t 1 12
define mnetcf = $mod_var
set t 1

define fieldtemp = ave(mnetcf,t=1,t=12)
define mnetcfann = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodann = aave(mnetcfann,$aave_region)
undefine fieldtemp

define fieldtemp = (2.0*ave(mnetcf,t=1,t=2)+mnetcf(t=12))/3.
define mnetcfdjf = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemoddjf = aave(mnetcfdjf,$aave_region)
undefine fieldtemp

define fieldtemp = ave(mnetcf,t=3,t=5)
define mnetcfmam = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodmam = aave(mnetcfmam,$aave_region)
undefine fieldtemp

define fieldtemp = ave(mnetcf,t=6,t=8)
define mnetcfjja = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodjja = aave(mnetcfjja,$aave_region)
undefine fieldtemp

define fieldtemp = ave(mnetcf,t=9,t=11)
define mnetcfson = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodson = aave(mnetcfson,$aave_region)
undefine fieldtemp
...
define obsnetcfann = ave(newcldfrc,t=1,t=12)
define aveobsann = aave(obsnetcfann,$aave_region)

define obsnetcfdjf = (2.*ave(newcldfrc,t=1,t=2)+newcldfrc(t=12))/3.
define aveobsdjf = aave(obsnetcfdjf,$aave_region)

define obsnetcfmam = ave(newcldfrc,t=3,t=5)
define aveobsmam = aave(obsnetcfmam,$aave_region)

define obsnetcfjja = ave(newcldfrc,t=6,t=8)
define aveobsjja = aave(obsnetcfjja,$aave_region)

define obsnetcfson = ave(newcldfrc,t=9,t=11)
define aveobsson = aave(obsnetcfson,$aave_region)
...
define obsnetcfann = ave($obs_var,t=1,t=12)
define aveobsann = aave(obsnetcfann,$aave_region)

define obsnetcfdjf = ave($obs_var,t=10,t=12)
define aveobsdjf = aave(obsnetcfdjf,$aave_region)

define obsnetcfmam = ave($obs_var,t=1,t=3)
define aveobsmam = aave(obsnetcfmam,$aave_region)

define obsnetcfjja = ave($obs_var,t=4,t=6)
define aveobsjja = aave(obsnetcfjja,$aave_region)

define obsnetcfson = ave($obs_var,t=7,t=9)
define aveobsson = aave(obsnetcfson,$aave_region)
...
define obsnetcfann = ave(obsclim,t=1,t=12)
define aveobsann = aave(obsnetcfann,$aave_region)

define obsnetcfdjf = ave(obsclim,t=10,t=12)
define aveobsdjf = aave(obsnetcfdjf,$aave_region)

define obsnetcfmam = ave(obsclim,t=1,t=3)
define aveobsmam = aave(obsnetcfmam,$aave_region)

define obsnetcfjja = ave(obsclim,t=4,t=6)
define aveobsjja = aave(obsnetcfjja,$aave_region)

define obsnetcfson = ave(obsclim,t=7,t=9)
define aveobsson = aave(obsnetcfson,$aave_region)
...
define obsnetcfann = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsann = aave(obsnetcfann,$aave_region)
undefine fieldtemp

define fieldtemp = (2.*ave(newcldfrc,t=1,t=2)+newcldfrc(t=12))/3.
define obsnetcfdjf = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsdjf = aave(obsnetcfdjf,$aave_region)
undefine fieldtemp

define fieldtemp = ave(newcldfrc,t=3,t=5)
define obsnetcfmam = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsmam = aave(obsnetcfmam,$aave_region)
undefine fieldtemp

define fieldtemp = ave(newcldfrc,t=6,t=8)
define obsnetcfjja = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsjja = aave(obsnetcfjja,$aave_region)

define fieldtemp = ave(newcldfrc,t=9,t=11)
define obsnetcfson = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsson = aave(obsnetcfson,$aave_region)
undefine fieldtemp
EOF
    breaksw
...
define mnetcfann = ave(mnetcf,t=1,t=12)
define avemodann = aave(mnetcfann,$aave_region)

define mnetcfdjf = (2.0*ave(mnetcf,t=1,t=2)+mnetcf(t=12))/3.
define avemoddjf = aave(mnetcfdjf,$aave_region)

define mnetcfmam = ave(mnetcf,t=3,t=5)
define avemodmam = aave(mnetcfmam,$aave_region)

define mnetcfjja = ave(mnetcf,t=6,t=8)
define avemodjja = aave(mnetcfjja,$aave_region)

define mnetcfson = ave(mnetcf,t=9,t=11)
define avemodson = aave(mnetcfson,$aave_region)
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCF $stats_region (W/m\`a2\`n)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCF $stats_region (W/m\`a2\`n) FM1 Edition2_Rev1(SWCF)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCF $stats_region (W/m\`a2\`n) FM1 Edition2D-Rev1(SWCF)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCF $stats_region (W/m\`a2\`n) XTRK(SWCF)&FM1(LWCF) Edition2D-Rev1(SWCF)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCRESFC $stats_region (W/m\`a2\`n)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation mnetcf avemod obsnetcf aveobs NETCRE $stats_region (W/m\`a2\`n)
EOF
    breaksw
