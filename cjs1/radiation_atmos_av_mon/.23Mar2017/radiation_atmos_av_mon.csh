...
echo -n '...finished dmget'
gcp $filelist . || exit 1
echo ' and file copy to: '$cwd
echo
...
echo 'extract model variables "'$varlist'" from:'
echo $in_data_file
...
if ( $#in_data_file == 1 ) then
  ...
  ncks -v $varlist -a -c -h -F $in_data_file[1] $climo_file || exit 1
else
  # 12 monthly climo files (cat together)
  ncrcat -h -v $varlist $in_data_file $climo_file || exit 1
endif
rm -f $in_data_file || exit 1
...
#  make plots for radiation variables for each type of observed radiation...

foreach obs_radiation ( ERBE CERES_ES4 CERES_SRBAVG_nonGEO CERES_SRBAVG_GEO CERES_EBAF CERES_EBAF_Ed2.6 \
...
switch ( $obs_radiation )
  ...
  case CERES_EBAF_ATM_Ed2.7:
    set obs_radiation_sdir = CERES_EBAF_Ed2.7
    breaksw
  case CERES_EBAF_TOA_Ed2.8:
  case CERES_EBAF_SFC_Ed2.8:
  case CERES_EBAF_ATM_Ed2.8:
    set obs_radiation_sdir = CERES_EBAF_Ed2.8/v2
    breaksw
  default:
    set obs_radiation_sdir = $obs_radiation
    breaksw
endsw

set obs_file_dir = $FRE_ANALYSIS_ARCHIVE/cjs/radiation_atmos_av_mon/$obs_radiation_sdir

#  obs data local storage directory

set obs_file_work_dir = $WORK_DIR/INPUT/$obs_radiation_sdir
mkdir -p $obs_file_work_dir || exit 1

echo
echo 'copy obs compressed tar file from directory:'
echo $obs_file_dir
echo 'to:'
echo $obs_file_work_dir
dmget $obs_file_dir/data.tar.gz || exit 1
gcp $obs_file_dir/data.tar.gz $obs_file_work_dir || exit 1
echo '...finished'

#  plot files local storage directory

set local_plot_file_dir = $local_run_dir/plot_file/$obs_radiation
...
switch ( $obs_radiation )
  case ERBE:
    ...
    set obs_radiation_plot_file = erbe
    #
    #  plot annotation
    #
  ...
  case CERES_ES4:
    ...
    set obs_radiation_plot_file = ceres_es4
    #
    #  plot annotation
    #
  ...
  case CERES_SRBAVG_nonGEO:
    ...
    set obs_radiation_plot_file = ceres_srbavg_nongeo
    #
    #  plot annotation
    #
  ...
  case CERES_SRBAVG_GEO:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_srbavg_geo
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_Ed2.6:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_ed2.6
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_TOA_Ed2.7:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_toa_ed2.7
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_SFC_Ed2.7:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_sfc_ed2.7
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_ATM_Ed2.7:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_atm_ed2.7
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_TOA_Ed2.8:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_toa_ed2.8
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_SFC_Ed2.8:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_sfc_ed2.8
    #
    #  plot annotation
    #
  ...
  case CERES_EBAF_ATM_Ed2.8:
    ...
    set obs_nlon = 360  obs_dlon = 1.0  obs_lon1 =   0.5  obs_lon2 = 359.5
    set obs_nlat = 180  obs_dlat = 1.0  obs_lat1 = -89.5  obs_lat2 =  89.5
    set obs_radiation_plot_file = ceres_ebaf_atm_ed2.8
    #
    #  plot annotation
    #
...
set var_plot_file = $local_plot_file_dir/$var.${obs_radiation_plot_file}.plot
...
set obs_radiation = $obs_radiation
