...
set num_mod_file = 2
set mod_var = 'swdn_toa-swup_toa'

# start the plot file

cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/nswt.toa.mon.ltm.nc
EOF
...
cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/Total-sky/swabs.CER_ES4_Terra-FM1_Edition2_Rev1.climo.nc
EOF
...
cat << EOF > $plot_file
* open observation file
open $obs_in_data_dir/CER_SRBAVG1_Terra-XTRK-Edition2D.GEO-Rev1.climo.ctl
EOF
...
sdfopen $obs_in_data_dir/clim_swinc.CERES_EBAF_TOA_Terra_Edition1A_200003-200510.nc
sdfopen $obs_in_data_dir/clim_swup.CERES_EBAF_TOA_Terra_Edition1A_200003-200510.nc
EOF
...
set obs_var = 'solar_mon-toa_sw_all_mon'
set ts_obsclim = 0
set tf_obsclim = 120
...
switch ( $diag_var )
  case swabs:
    ...
    breaksw
  case swabs_clr:
    set obs_var = 'solar_mon-toa_sw_clr_mon'
    set mod_var = 'swdn_toa-swup_toa_clr'
    set var_name = 'SWABS_CLR'
    breaksw
endsw
...
switch ( $diag_var )
  case netsw:
    set obs_var = 'sfc_net_sw_all_'
    set mod_var = 'swdn_sfc-swup_sfc'
    set var_name = 'SWABSSFC'
    breaksw
  case swdn:
    set obs_var = 'sfc_sw_down_all'
    set mod_var = 'swdn_sfc'
    set var_name = 'SWDNSFC'
    breaksw
  case swdn_clr:
    set obs_var = 'sfc_sw_down_clr'
    set mod_var = 'swdn_sfc_clr'
    set var_name = 'SWDNSFC_CLR'
    breaksw
  case swup:
    set obs_var = 'sfc_sw_up_all_m'
    set mod_var = 'swup_sfc'
    set var_name = 'SWUPSFC'
    breaksw
  case swup_clr:
    set obs_var = 'sfc_sw_up_clr_m'
    set mod_var = 'swup_sfc_clr'
    set var_name = 'SWUPSFC_CLR'
    breaksw
endsw
...
#  atmospheric SW flux is upward (net flux = upward flux minus downward flux,
...
switch ( $diag_var )
  case netsw_diff:
    # SWABS at TOA minus SWABS at SFC
    set obs_var = '(solar_mon.1-toa_sw_all_mon.1) - sfc_net_sw_all_.2'
    set mod_var = '(swdn_toa-swup_toa) - (swdn_sfc-swup_sfc)'
    set var_name = 'NETSW_DIFF'
    breaksw
  case swup_diff:
    # SWUP at TOA minus SWUP at SFC
    set obs_var = 'toa_sw_all_mon.1 - sfc_sw_up_all_m.2'
    set mod_var = 'swup_toa - swup_sfc'
    set var_name = 'SWUP_DIFF'
    breaksw
endsw
...
#  defined as downward flux minus upward flux, and is positive when energy is
#  deposited toward the surface.  See "3.0 Cautions and Helpful Hints" on
#  page 4 in /net/cjs/data/ceres/CERES_EBAF-Surface_Ed2.8/v2/CERES_EBAF-Surface_Ed2.8_DQS.pdf
...
define fieldtemp2 = ave(swup_toa,t=1,t=12)
define modswann = regrid2(fieldtemp1-fieldtemp2,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodann = aave(modswann,$aave_region)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=12)+swdn_toa(t=1)+swdn_toa(t=2))/3.
define fieldtemp2 = (swup_toa(t=12)+swup_toa(t=1)+swup_toa(t=2))/3.
define modswdjf = regrid2(fieldtemp1-fieldtemp2,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemoddjf = aave(modswdjf,$aave_region)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=3)+swdn_toa(t=4)+swdn_toa(t=5))/3.
define fieldtemp2 = (swup_toa(t=3)+swup_toa(t=4)+swup_toa(t=5))/3.
define modswmam = regrid2(fieldtemp1-fieldtemp2,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodmam = aave(modswmam,$aave_region)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=6)+swdn_toa(t=7)+swdn_toa(t=8))/3.
define fieldtemp2 = (swup_toa(t=6)+swup_toa(t=7)+swup_toa(t=8))/3.
define modswjja = regrid2(fieldtemp1-fieldtemp2,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodjja = aave(modswjja,$aave_region)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=9)+swdn_toa(t=10)+swdn_toa(t=11))/3.
define fieldtemp2 = (swup_toa(t=9)+swup_toa(t=10)+swup_toa(t=11))/3.
define modswson = regrid2(fieldtemp1-fieldtemp2,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodson = aave(modswson,$aave_region)
undefine fieldtemp1
undefine fieldtemp2
...
set z 1
set t 1 12
define modsw = $mod_var
set t 1

define fieldtemp = ave(modsw,t=1,t=12)
define modswann = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodann = aave(modswann,$aave_region)
undefine fieldtemp

define fieldtemp = (2.0*ave(modsw,t=1,t=2)+modsw(t=12))/3.
define modswdjf = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemoddjf = aave(modswdjf,$aave_region)
undefine fieldtemp

define fieldtemp = ave(modsw,t=3,t=5)
define modswmam = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodmam = aave(modswmam,$aave_region)
undefine fieldtemp

define fieldtemp = ave(modsw,t=6,t=8)
define modswjja = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodjja = aave(modswjja,$aave_region)
undefine fieldtemp

define fieldtemp = ave(modsw,t=9,t=11)
define modswson = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define avemodson = aave(modswson,$aave_region)
undefine fieldtemp
...
define ffactor = 1.
define obsswann = ffactor*ave(newsw,t=1,t=12)
define aveobsann = aave(obsswann,$aave_region)

define obsswdjf = ffactor*(newsw(t=12)+newsw(t=1)+newsw(t=2))/3.
define aveobsdjf = aave(obsswdjf,$aave_region)

define obsswmam = ffactor*(newsw(t=3)+newsw(t=4)+newsw(t=5))/3.
define aveobsmam = aave(obsswmam,$aave_region)

define obsswjja = ffactor*(newsw(t=6)+newsw(t=7)+newsw(t=8))/3.
define aveobsjja = aave(obsswjja,$aave_region)

define obsswson = ffactor*(newsw(t=9)+newsw(t=10)+newsw(t=11))/3.
define aveobsson = aave(obsswson,$aave_region)
...
define obsswann = ave($obs_var,t=1,t=12)
define aveobsann = aave(obsswann,$aave_region)

define obsswdjf = ave($obs_var,t=10,t=12)
define aveobsdjf = aave(obsswdjf,$aave_region)

define obsswmam = ave($obs_var,t=1,t=3)
define aveobsmam = aave(obsswmam,$aave_region)

define obsswjja = ave($obs_var,t=4,t=6)
define aveobsjja = aave(obsswjja,$aave_region)

define obsswson = ave($obs_var,t=7,t=9)
define aveobsson = aave(obsswson,$aave_region)
...
set z 1
set t 1 12
define obsclim = clim_swinc.1-clim_swup.2
set t 1

define obsswann = ave(obsclim,t=1,t=12)
define aveobsann = aave(obsswann,$aave_region)

define obsswdjf = ave(obsclim,t=10,t=12)
define aveobsdjf = aave(obsswdjf,$aave_region)

define obsswmam = ave(obsclim,t=1,t=3)
define aveobsmam = aave(obsswmam,$aave_region)

define obsswjja = ave(obsclim,t=4,t=6)
define aveobsjja = aave(obsswjja,$aave_region)

define obsswson = ave(obsclim,t=7,t=9)
define aveobsson = aave(obsswson,$aave_region)
...
define obsswann = ffactor*regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsann = aave(obsswann,$aave_region)
undefine fieldtemp

define fieldtemp = (newsw(t=12)+newsw(t=1)+newsw(t=2))/3.
define obsswdjf = ffactor*regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsdjf = aave(obsswdjf,$aave_region)
undefine fieldtemp

define fieldtemp = (newsw(t=3)+newsw(t=4)+newsw(t=5))/3.
define obsswmam = ffactor*regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsmam = aave(obsswmam,$aave_region)
undefine fieldtemp

define fieldtemp = (newsw(t=6)+newsw(t=7)+newsw(t=8))/3.
define obsswjja = ffactor*regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsjja = aave(obsswjja,$aave_region)

define fieldtemp = (newsw(t=9)+newsw(t=10)+newsw(t=11))/3.
define obsswson = ffactor*regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsson = aave(obsswson,$aave_region)
undefine fieldtemp
EOF
    breaksw
...
define obsswann = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsann = aave(obsswann,$aave_region)
undefine fieldtemp

define fieldtemp = ave($obs_var,t=10,t=12)
define obsswdjf = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsdjf = aave(obsswdjf,$aave_region)
undefine fieldtemp

define fieldtemp = ave($obs_var,t=1,t=3)
define obsswmam = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsmam = aave(obsswmam,$aave_region)
undefine fieldtemp

define fieldtemp = ave($obs_var,t=4,t=6)
define obsswjja = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsjja = aave(obsswjja,$aave_region)
undefine fieldtemp

define fieldtemp = ave($obs_var,t=7,t=9)
define obsswson = regrid2(fieldtemp,$regrid_dlon,$regrid_dlat,ba_p1,$regrid_lon1,$regrid_lat1)
define aveobsson = aave(obsswson,$aave_region)
undefine fieldtemp
EOF
    breaksw
...
define fieldtemp1 = ave(swdn_toa,t=1,t=12)
define fieldtemp2 = ave(swup_toa,t=1,t=12)
define modswann = fieldtemp1-fieldtemp2
define avemodann = aave(modswann,g)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=12)+swdn_toa(t=1)+swdn_toa(t=2))/3.
define fieldtemp2 = (swup_toa(t=12)+swup_toa(t=1)+swup_toa(t=2))/3.
define modswdjf = fieldtemp1-fieldtemp2
define avemoddjf = aave(modswdjf,g)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=6)+swdn_toa(t=7)+swdn_toa(t=8))/3.
define fieldtemp2 = (swup_toa(t=6)+swup_toa(t=7)+swup_toa(t=8))/3.
define modswjja = fieldtemp1-fieldtemp2
define avemodjja = aave(modswjja,g)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=3)+swdn_toa(t=4)+swdn_toa(t=5))/3.
define fieldtemp2 = (swup_toa(t=3)+swup_toa(t=4)+swup_toa(t=5))/3.
define modswmam = fieldtemp1-fieldtemp2
define avemodmam = aave(modswmam,g)
undefine fieldtemp1
undefine fieldtemp2

define fieldtemp1 = (swdn_toa(t=9)+swdn_toa(t=10)+swdn_toa(t=11))/3.
define fieldtemp2 = (swup_toa(t=9)+swup_toa(t=10)+swup_toa(t=11))/3.
define modswson = fieldtemp1-fieldtemp2
define avemodson = aave(modswson,g)
undefine fieldtemp1
undefine fieldtemp2
...
define modswann = ave(modsw,t=1,t=12)
define avemodann = aave(modswann,$aave_region)

define modswdjf = (2.0*ave(modsw,t=1,t=2)+modsw(t=12))/3.
define avemoddjf = aave(modswdjf,$aave_region)

define modswmam = ave(modsw,t=3,t=5)
define avemodmam = aave(modswmam,$aave_region)

define modswjja = ave(modsw,t=6,t=8)
define avemodjja = aave(modswjja,$aave_region)

define modswson = ave(modsw,t=9,t=11)
define avemodson = aave(modswson,$aave_region)
...
cat << EOF >> $plot_file
run plot_3panel_radiation modsw avemod obssw aveobs SWABS $stats_region (W/m\`a2\`n)
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation modsw avemod obssw aveobs SWABS $stats_region (W/m\`a2\`n) FM1 Edition2_Rev1
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation modsw avemod obssw aveobs SWABS $stats_region (W/m\`a2\`n) FM1 Edition2D-Rev1
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation modsw avemod obssw aveobs SWABS $stats_region (W/m\`a2\`n) XTRK Edition2D-Rev1
EOF
    breaksw
...
cat << EOF >> $plot_file
run plot_3panel_radiation modsw avemod obssw aveobs $var_name $stats_region (W/m\`a2\`n)
EOF
    breaksw
