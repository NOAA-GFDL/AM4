...
cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/swcf.CER_ES4_Terra-FM1_Edition2_Rev1.climo.nc
EOF
...
cat << EOF > $plot_file
* open observation file
sdfopen $obs_in_data_dir/clim_swcre.CERES_EBAF_TOA_Terra_Edition1A_200003-200510.nc
EOF
