...
real            :: MIN_ICE_ALB = 0.55   ! coupled model uses 0.55
...
subroutine ice_thm_param(alb_sno_in, alb_ice_in, pen_ice_in, opt_dep_ice_in, &
                         ...
                         max_ice_alb_in, min_ice_alb_in, &
                         cm2_bugs_in, ks_in, h_lo_lim_in )
    real, intent(in)      :: alb_sno_in, alb_ice_in, pen_ice_in 
    real, intent(in)      :: opt_dep_ice_in, t_range_melt_in
    real, intent(in)   :: max_ice_alb_in, min_ice_alb_in
...
logical, intent(in)   :: cm2_bugs_in
  ...
  MAX_ICE_ALB = max_ice_alb_in
  MIN_ICE_ALB = min_ice_alb_in
